...
export default function StudentCommunity() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        const [commRes, usersRes] = await Promise.allSettled([
          API.get("communities/"),
          API.get("users/"),
        ]);
          ...
          <aside>
            ...
            <div style={{ background: "#fff", border: "1.5px solid #e5e4e7", borderRadius: "20px", overflow: "hidden", marginBottom: "14px" }}>
              ...
              {[
                ...
                { to: "/student/tuition",      icon: "📚", label: "Tuition" },
              ].map((item) => (
                <Link
                  key={item.to}
                  to={item.to}
          ...
          <main>
            ...
            <div style={{ position: "relative", overflow: "hidden", borderRadius: "24px", marginBottom: "16px" }}>
              ...
              <div style={{ position: "absolute", inset: 0, padding: "32px 36px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                ...
                <div style={{ fontSize: "13px", color: "rgba(255,255,255,0.9)", marginBottom: "20px", maxWidth: "440px", lineHeight: 1.55 }}>
                  Join communities, share knowledge, and grow together with your peers and mentors.
                </div>
              </div>
            </div>
            ...
            {loading ? (
              ...
              <div style={{ textAlign: "center", padding: "48px", color: "#666" }}>
                ...
                <div style={{ fontSize: "16px", fontWeight: 700, marginBottom: "8px" }}>No communities found</div>
              ...
              filtered.map((c) => {
                ...
                return (
                  <div
                    key={c.id}
                    style={{ background: "#fff", border: "1.5px solid #e5e4e7", borderRadius: "18px", padding: "20px", marginBottom: "12px", display: "flex", alignItems: "flex-start", gap: "16px", transition: "box-shadow 0.15s" }}
                  ...
                  >
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "8px", alignItems: "flex-end" }}>
                      <button
                        onClick={() => navigate(`/student/communities/${c.id}`)}
